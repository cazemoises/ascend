...
The web frontend is a single-page application (SPA) built with Vite, React, and TypeScript. It provides the user interface for browsing challenges, submitting solutions, and viewing results. During development it proxies API requests to the local Go API server.
